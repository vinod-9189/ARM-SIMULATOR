...
var changeToShifter = function ()               // DISPLAYS THE DIFFERENT SHIFTER INSTRUCTIONS AVAILABLE.
{
    ...
    <tr align="center">\n\
        ...
        <td align="center">\n\
            <div class="btn-group btn-group-toggle" data-toggle="buttons">\n\
                <label class="btn btn-secondary" onclick=shifterValues("LSR"); data-trigger="hover" data-toggle="popover" title="LOGICAL SHIFT RIGHT" data-content="THE SECOND OPERAND IS DIVIDED BY THE VALUE GIVEN FOR SHIFTER.">\n\
                    LSR\n\
                </label>\n\
            </div>\n\
        </td>\n\
        <td align="center">\n\
            <div class="btn-group btn-group-toggle" data-toggle="buttons">\n\
                <label class="btn btn-secondary" onclick=shifterValues("ASR"); data-trigger="hover" data-toggle="popover" title="ARITHMETIC SHIFT RIGHT" data-content="BITS ARE MOVED RIGHT N TIMES. WHERE N IS VALUE MENTIONED AS SHIFTER VALUE.DIVIDE THE VALUE BY (2) N TIMES">\n\
                    ASR\n\
                </label>\n\
            </div>\n\
        </td>\n\
